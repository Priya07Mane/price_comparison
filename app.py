...
mock_stores = [
    {"name": "Amazon", "base_url": "https://amazon.com", "color": "bg-orange-500"},
    {"name": "eBay", "base_url": "https://ebay.com", "color": "bg-blue-500"},
    {"name": "Walmart", "base_url": "https://walmart.com", "color": "bg-blue-600"},
    {"name": "Best Buy", "base_url": "https://bestbuy.com", "color": "bg-yellow-500"},
    {"name": "Target", "base_url": "https://target.com", "color": "bg-red-500"}
]
...
#     # This would normally process results, but for simplicity we'll return a mock
#     return render_template('results_summary.html', results=results)
